$(function () {
    ...
    $(window).scroll(function () {
        ...
        var efecto = $("#segunda").offset().top-48;
        ...
        if ($scroll >= (efecto)) {
            ...
            $men.css("background-color","white");
            ...
            $top.css("opacity", "0");
            //$menuBef.css("top", "");
            $men.css("background-color","rgba(255,255,255,0.1)");
    ...
    enlaces.on("click", function (e) {
        ...
        var topCaja = $(tbox).offset().top-48;
    ...
    function myCallback() {
        ...
        if (t === "PEDILO AHORA") {
            ...
            c.setAttribute("value", "PEDILO AHORA");
        }
